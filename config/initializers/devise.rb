...
Devise.setup do |config|
  ...
  # config.secret_key = '29fbb2ffc7301a939c88db3a8ffaf13995759b74a7088f6e98ced8
  # 629b8288c07a7a2faa98ab12b8379e49566905768dee7414c57fe76cdbca874d08e0575317'
  ...
  # (the default
  # algorithm), the cost increases exponentially with number of
  # stretches (e.g.
  ...
  # config.pepper = '43c5dddd3ed84e4d1eead3e3deab770536153ecf9e58b94812a1a4d37
  # 82d517362bdc387659920876626f42b9edfb6d55cf80bda15b1d3a5735910fd68262cd8'
  ...
  # Turn scoped views on. Before rendering "sessions/new",it first check for
  ...
  # change the failure app, you can configure inside the config.warden block.
  #
